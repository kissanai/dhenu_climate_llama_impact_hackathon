...
import com.ml.dhenu.docqa.data.Document
import com.ml.dhenu.docqa.data.DocumentsDB
import com.ml.dhenu.docqa.domain.readers.Readers
import com.ml.dhenu.docqa.domain.splitters.WhiteSpaceSplitter
...
class DocumentsUseCase(
    ...
    suspend fun addDocument(
        ...
        withContext(Dispatchers.IO) {
            ...
            val chunks = WhiteSpaceSplitter.createChunks(text, chunkSize = 400, chunkOverlap = 50)
